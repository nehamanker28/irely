...
//                     var _table = new Invoice();
//                     var _sql = me.sqliteBrl.createtable('invoice',_table.fields()[0]);
...
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.getData('invoice').then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async add(record: Invoice) {
//         var me = this;
//         try
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.addData('invoice',record).then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async addBulk(record: Invoice, data: any) {
//         var me = this;
//         try
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.addBulkData('invoice',record,data).then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async update(record: Invoice) {
//         var me = this;
//         try
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.updateData('invoice',record).then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.droptable('invoice').then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async getInvoiceQuery(query: string) {
//         var me = this;
//         console.log(query);
//         try
//         {
