...
import { NavController, NavParams, LoadingController, Route } from '@ionic/angular';
...
export class LoginLoadingPage {
  ...
  ionViewDidLoad() {    
    this.navCtrl.navigateRoot("LoginMainPage", { authenticated: false }); //MenuMainPage //LoginMainPage //CustomerInvoicePage
