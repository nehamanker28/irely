...
import { RefreshIntervalServiceService} from '../../providers/refresh-interval-service.service';
...
export class ShiftPage extends Service<Token> {
  ...
  shiftNumberStatus:boolean = false;
  ...
  constructor(public navCtrl: NavController,
    ...
    private refreshIntervalService : RefreshIntervalServiceService,
