...
//                     var _table = new Item();
//                     var _sql = me.sqliteBrl.createtable('item',_table.fields()[0]);
...
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.getData('item').then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async add(record: Item) {
//         var me = this;
//         try
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.addData('item',record).then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async addBulk(record: Item, data: any) {
//         var me = this;
//         try
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.addBulkData('item',record,data).then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async update(record: Item) {
//         var me = this;
//         try
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.updateData('item',record).then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.droptable('item').then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async getItemQuery(query: string) {
//         var me = this;
//         console.log(query);
//         try
//         {
