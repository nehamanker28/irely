...
//                     var _table = new Order();
//                     var _sql = me.sqliteBrl.createtable('orders',_table.mapping);
...
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.getData('orders').then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async add(record: Order) {
//         var me = this;
//         try
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.addData('orders',record).then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async addBulk(record: Order, data: any) {
//         var me = this;
//         try
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.addBulkData('orders',record,data).then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async update(record: Order) {
//         var me = this;
//         try
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.updateData('orders',record).then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//         {
//             return new Promise((resolve, reject) => {
//                 me.sqliteBrl.droptable('orders').then(res => {
//                     resolve(res);
//                 })
//                 .catch(e => {
//                     console.log(e);          
...
//     async getOrderQuery(query: string) {
//         var me = this;
//         console.log(query);
//         try
//         {
