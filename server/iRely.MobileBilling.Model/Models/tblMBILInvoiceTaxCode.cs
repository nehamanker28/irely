...
{
    public partial class tblMBILInvoiceTaxCode : BaseEntity
    {
        public int intInvoiceTaxId { get; set; }
        ...
        public tblMBILInvoiceItem tblMBILInvoiceItem { get; set; }
    }

    public class vyuMBILInvoiceTaxCode
    {
        public int intInvoiceTaxId { get; set; }
        public int? intInvoiceItemId { get; set; }
        public int? intItemId { get; set; }
