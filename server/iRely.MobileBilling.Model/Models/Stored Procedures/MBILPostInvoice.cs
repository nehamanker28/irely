...
namespace iRely.MobileBilling.Model
{
  ...
  {
    public virtual async Task<string> MBILPostInvoice(string param, bool toRecap, bool toPost, int userId)
    {
      ...
      try
      {
        ...
        command.CommandText = "uspMBILProcessInvoices";
        ...
        var _result = "Invoice successfully posted.";
